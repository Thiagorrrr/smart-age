const DataShipping = {
    ...
    TextLinkBtn1: {
        ...
        paragraph: [
            ...
            {
                title: " Items must be returned in their original condition with the security tag intact. All return packages must have the RA# clearly written/placed on the return package. Note: If different authorized returns are being shipped in the same package, write/place additional RA#s on the return package. Merchandise must be shipped with pre-paid postage to the address indicated on the RA label. We suggest insuring the package for the full purchase price of the item(s) for coverage. Processing for returns or repairs will begin after package is delivered to us. All returns are subject to inspection by our Quality Control team before a refund is processed.",
            },
            {
                classNames: "bold",
                title: "Exchanges",
